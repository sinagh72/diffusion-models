...
if __name__ == "__main__":
    ...
    epochs = 100
    comments = "f_ld_vqgan_1"
    ae_model = "vqgan_1"
    diffusion_model = "ld_vqgan_1"
    devices = [0]
    img_size = 128
    ...
    for data_module, client_name, classes in data_modules:
        cls_model = CLS(encoder=diffusion, feature_dim=512, classes=classes, lr=4e-3)
        ...
        tb_logger = TensorBoardLogger(save_dir=save_path, name=client_name)
        checkpoint = ModelCheckpoint(dirpath=os.path.join(save_path, client_name),
